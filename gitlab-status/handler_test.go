...
func Test_appendParameters(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			url:         "https://some.random.url/api/v4/projects/3/statuses/99a7c6009c43cca39c61977ab8d3abdd13d7b111",
			state:       "stack-deploy",
			desc:        "some description",
			context:     "context",
			expectedURL: "https://some.random.url/api/v4/projects/3/statuses/99a7c6009c43cca39c61977ab8d3abdd13d7b111?context=context&description=some+description&state=stack-deploy",
		},
		{
			...
			desc:        "some description",
			context:     "context",
			expectedURL: "https://some.random.url/api/v4/projects/3/statuses/99a7c6009c43cca39c61977ab8d3abdd13d7b111?context=context&description=some+description&state=failed",
		},
	}
	for _, test := range tests {
		t.Run(test.title, func(t *testing.T) {
